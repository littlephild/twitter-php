The Twitter PHP source code repository will now be managed using the Git. You can browse the source, clone it, and submit patches at our new Github site at:
